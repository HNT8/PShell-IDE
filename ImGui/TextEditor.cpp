...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::PowerShell()
{
	static bool inited = false;
	static LanguageDefinition langDef;
	if (!inited)
	{
		static const char* const keywords[] = {
			"", "Begin", "Break", "Catch", "Class", "Continue", "Data", "Define", "Do", "DynamicParam", "Else", "Elseif", "End", "Enum", "Exit", "Filter", "Finally", "For", "ForEach", "From", "Function", "Hidden", "If", "In", "InlineScript", "Param", "Process", "Return", "Static", "Switch", "Throw", "Trap", "Try", "Until", "Using", "Var", "While"
		};
